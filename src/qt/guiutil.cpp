...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("friendshipcoin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("friendshipcoin://"))
    {
        uri.replace(0, 11, "friendshipcoin:");
    }
...
{
    return GetAutostartDir() / "friendshipcoin.desktop";
}
    ...
    QMessageBox(parent)
{
    header = tr("Friendshipcoin-Qt") + " " + tr("version") + " " +
        ...
        tr("Usage:") + "\n" +
        "  friendshipcoin-qt [" + tr("command-line options") + "]                     " + "\n";
